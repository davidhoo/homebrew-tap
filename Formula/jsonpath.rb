class Jsonpath < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/davidhoo/jsonpath/releases/download/v1.0.1/jp-darwin-arm64.tar.gz"
      sha256 "53bae8aeb8a7c32f983ba9ddb794eb4ad57d3c35d980e617c36f31fb3eff9e6b"
    else
      url "https://github.com/davidhoo/jsonpath/releases/download/v1.0.1/jp-darwin-amd64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/davidhoo/jsonpath/releases/download/v1.0.1/jp-linux-arm64.tar.gz"
      sha256 "f69ac99d468737a5bd09d067e1a1c30ffe0c60adf706dbf75d9c3262a2833b50"
    else
      url "https://github.com/davidhoo/jsonpath/releases/download/v1.0.1/jp-linux-amd64.tar.gz"
